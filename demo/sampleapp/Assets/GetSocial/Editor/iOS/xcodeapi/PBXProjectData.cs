...
namespace UnityEditor.iOS.Xcode.GetSocial
{
    ...
    using PBXEmbedFrameworksBuildPhaseSection   = KnownSectionBase<PBXCopyFilesBuildPhaseData>;
    ...
    internal class PBXProjectData
    {
        ...
        public PBXEmbedFrameworksBuildPhaseSection embedFrameworks = null;
        ...
        void RefreshAuxMaps()
        {
            foreach (var targetEntry in nativeTargets.GetEntries())
            {
                ...
                foreach (string phaseGuid in targetEntry.Value.phases)
                {
                    ...
                    if (embedFrameworks.HasEntry(phaseGuid))
                        RefreshBuildFilesMapForBuildFileGuidList(map, embedFrameworks[phaseGuid]);
        ...
        public void Clear()
        {
            ...
            embedFrameworks = new PBXCopyFilesBuildPhaseSection("PBXCopyFilesBuildPhase");
            ...
            m_Section = new Dictionary<string, SectionBase>
            {
                ...
                { "PBXEmbedFrameworksBuildPhase", embedFrameworks},
            ...
            m_SectionOrder = new List<string>{
                "PBXBuildFile", "PBXContainerItemProxy", "PBXEmbedFrameworksBuildPhase" ,"PBXCopyFilesBuildPhase", "PBXFileReference",
